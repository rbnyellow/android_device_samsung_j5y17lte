...
#define MODEL_NAME_LEN 5  // e.g. "J530F"
#define BUILD_NAME_LEN 8  // e.g. "XXU2ARB3"
#define CODENAME_LEN   10 // e.g. "j5y17lte"
...
void vendor_load_properties()
{
    ...
    const std::string device = "j5y17lte";
    ...
    if (name.size() == 0) {
        LOG(ERROR) << "Could not detect codename, forcing j5y17lte";
        name = "j5y17lte";
    }
